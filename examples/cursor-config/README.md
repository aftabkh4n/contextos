...
To attempt setup, refer to the
[Cursor MCP documentation](https://docs.cursor.com/context/model-context-protocol)
for how to register an MCP server, and use the binary path and command from
[examples/claude-code-config/README.md](../claude-code-config/README.md).
